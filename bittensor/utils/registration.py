...
def _solve_for_difficulty_fast_cuda(
    ...
    output_in_place: bool = True,
    update_interval: Optional[int] = None,
    TPB: Optional[int] = 512,
    dev_id: Optional[Union[List[int], int]] = None,
    n_samples: int = 10,
    alpha_: float = 0.80,
    log_verbose: bool = False,
) -> Optional[POWSolution]:
